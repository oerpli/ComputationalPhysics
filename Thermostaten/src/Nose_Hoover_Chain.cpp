...
Nose_Hoover_Chain::Nose_Hoover_Chain(Polymer &a_polymer, double a_temperature, double a_q1, double a_q2, double a_step) :
poly(a_polymer),
...
void Nose_Hoover_Chain::chain() {
	poly.update_ekin();
	g1 = (2.0*poly.ekin - (poly.monomers.size() - 1)*temperature) / q1;
	g2 = (q1*nuxi1*nuxi1 - temperature) / q2;
