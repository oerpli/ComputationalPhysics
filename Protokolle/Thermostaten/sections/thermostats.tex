...
\begin{equation*}
{\dot K_t} = \frac{K-K_t}{\tau} %die formel sieht ziemlich blöd aus finde ich grad - hat jmd eine idee für eine bessere konvention bzgl wunsch und aktueller temperatur?
\end{equation*}
...
Bussi et al improved Berendsens method with their thermostat by adding a properly constructed random force and through relaxing the velocity rescaling (similar to Berendsen compared to Gaussians thermostat).
