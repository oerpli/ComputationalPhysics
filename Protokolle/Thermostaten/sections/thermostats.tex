...
For this thermostat the choice of the stochastic term is somewhat arbitrary as it only influences speed of equilibration. In our implementation we chose the term proposed in the paper \cite{Bussi2007}.
